...
var author$project$Component$EntryList$Active = {$: 'Active'};
var author$project$Component$EntryList$All = {$: 'All'};
var author$project$Component$EntryList$Completed = {$: 'Completed'};
var author$project$Component$EntryList$Model = function (a) {
	return {$: 'Model', a: a};
};
var author$project$Component$EntryList$visibilityToString = function (visibility) {
	switch (visibility.$) {
		case 'All':
			return 'All';
		case 'Active':
...
var author$project$Component$EntryList$init = function (vizString) {
	var viz = _Utils_eq(
		author$project$Component$EntryList$visibilityToString(author$project$Component$EntryList$Active),
		vizString) ? author$project$Component$EntryList$Active : (_Utils_eq(
		author$project$Component$EntryList$visibilityToString(author$project$Component$EntryList$Completed),
		vizString) ? author$project$Component$EntryList$Completed : author$project$Component$EntryList$All);
	return author$project$Component$EntryList$Model(
		{editingId: elm$core$Maybe$Nothing, visibility: viz});
};
var author$project$Entry$Entry = function (a) {
	return {$: 'Entry', a: a};
};
...
var author$project$Entry$deserialize = function (e) {
	return author$project$Entry$Entry(
		{
			completed: e.completed,
			date: justinmimbs$date$Date$fromRataDie(e.date),
			description: e.description,
			id: e.id
		});
};
var author$project$Main$emptyModel = {entries: _List_Nil, field: '', lastOpenedRataDie: 0, nextId: 0, visibility: 'All'};
...
var author$project$Main$initModel = function (flags) {
	var serialized = A2(elm$core$Maybe$withDefault, author$project$Main$emptyModel, flags.model);
	return {
		activeDate: justinmimbs$date$Date$fromRataDie(0),
		entries: A2(elm$core$List$map, author$project$Entry$deserialize, serialized.entries),
		field: serialized.field,
		lastOpenedDate: justinmimbs$date$Date$fromRataDie(serialized.lastOpenedRataDie),
		listState: author$project$Component$EntryList$init(serialized.visibility),
		nextId: serialized.nextId,
		todayDate: elm$core$Maybe$Nothing
	};
};
...
var author$project$Component$EntryList$visibilityText = function (_n0) {
	var r = _n0.a;
	return author$project$Component$EntryList$visibilityToString(r.visibility);
};
var justinmimbs$date$Date$toRataDie = function (_n0) {
	var rd = _n0.a;
	return rd;
};
var author$project$Entry$serialize = function (_n0) {
	var r = _n0.a;
	return {
		completed: r.completed,
		date: justinmimbs$date$Date$toRataDie(r.date),
		description: r.description,
		id: r.id
	};
};
var author$project$Main$serialize = function (model) {
	return {
		entries: A2(elm$core$List$map, author$project$Entry$serialize, model.entries),
		field: model.field,
		lastOpenedRataDie: justinmimbs$date$Date$toRataDie(model.lastOpenedDate),
		nextId: model.nextId,
		visibility: author$project$Component$EntryList$visibilityText(model.listState)
	};
};
		...
		return elm$json$Json$Encode$object(
			_List_fromArray(
				[
					...
					_Utils_Tuple2(
					'lastOpenedRataDie',
					elm$json$Json$Encode$int($.lastOpenedRataDie)),
					_Utils_Tuple2(
					'nextId',
...
var author$project$Component$EntryList$NoOp = {$: 'NoOp'};
...
var author$project$Component$EntryList$update = F2(
	function (msg, _n0) {
		var r = _n0.a;
		switch (msg.$) {
			case 'NoOp':
			...
			case 'EditingEntry':
				...
				return _Utils_Tuple2(
					author$project$Component$EntryList$Model(
						_Utils_update(
							r,
							{
								editingId: elm$core$Maybe$Just(id)
							})),
					A2(
						elm$core$Task$attempt,
						function (_n2) {
							return author$project$Component$EntryList$NoOp;
						},
						focus));
			case 'FinishEdit':
				return _Utils_Tuple2(
					author$project$Component$EntryList$Model(
						_Utils_update(
							r,
							{editingId: elm$core$Maybe$Nothing})),
					elm$core$Platform$Cmd$none);
			default:
				var viz = msg.a;
				return _Utils_Tuple2(
...
var author$project$Entry$Completed = function (a) {
	return {$: 'Completed', a: a};
};
var author$project$Entry$Description = function (a) {
	return {$: 'Description', a: a};
};
var author$project$Entry$completed = function (_n0) {
	var r = _n0.a;
	return r.completed;
};
var author$project$Entry$date = function (_n0) {
	var r = _n0.a;
	return r.date;
};
var author$project$Entry$id = function (_n0) {
	var r = _n0.a;
	return r.id;
};
var author$project$Entry$new = F3(
	function (desc, eid, d) {
		return author$project$Entry$Entry(
			{completed: false, date: d, description: desc, id: eid});
	});
var author$project$Entry$update = F2(
	function (change, _n0) {
		var r = _n0.a;
...
var author$project$Entry$description = function (_n0) {
	var r = _n0.a;
...
var author$project$ImportEntries$incompleteInRange = F3(
	function (from, to, entry) {
		var openTo = A3(justinmimbs$date$Date$add, justinmimbs$date$Date$Days, -1, to);
		return (!author$project$Entry$completed(entry)) && A3(
			justinmimbs$date$Date$isBetween,
			from,
			openTo,
			author$project$Entry$date(entry));
	});
var author$project$ImportEntries$update = F3(
	function (from, to, entries) {
		var updateIfInRange = function (e) {
			return A3(author$project$ImportEntries$incompleteInRange, from, to, e) ? A3(
				author$project$Entry$new,
				author$project$Entry$description(e),
				author$project$Entry$id(e),
				to) : e;
		};
		return A2(elm$core$List$map, updateIfInRange, entries);
	});
var author$project$Main$EntryListMsg = function (a) {
	return {$: 'EntryListMsg', a: a};
};
var author$project$Main$setActiveDate = F2(
	function (model, date) {
...
var author$project$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			...
			case 'SetToday':
				var date = msg.a;
				var updatedModel = A2(author$project$Main$setActiveDate, model, date);
				return _Utils_Tuple2(
					_Utils_update(
						updatedModel,
						{
							todayDate: elm$core$Maybe$Just(date)
						}),
					elm$core$Platform$Cmd$none);
			case 'SetDate':
				var date = msg.a;
				return _Utils_Tuple2(
					A2(author$project$Main$setActiveDate, model, date),
					elm$core$Platform$Cmd$none);
			case 'ImportPrevious':
				var shouldImport = msg.a;
				var updated = function () {
					var _n1 = model.todayDate;
					if (_n1.$ === 'Just') {
						var today = _n1.a;
						var updatedEntries = shouldImport ? A3(author$project$ImportEntries$update, model.lastOpenedDate, today, model.entries) : model.entries;
						return _Utils_update(
							model,
							{entries: updatedEntries, lastOpenedDate: today});
					} else {
						return model;
					}
				}();
					...
					_Utils_update(
						model,
						{
							entries: elm$core$String$isEmpty(model.field) ? model.entries : _Utils_ap(
								...
								_List_fromArray(
									[
										A3(author$project$Entry$new, model.field, model.nextId, model.activeDate)
									])),
							field: '',
			...
			case 'UpdateEntry':
				var id = msg.a;
				var desc = msg.b;
				var updateById = function (entry) {
					return _Utils_eq(
						id,
						author$project$Entry$id(entry)) ? A2(
						author$project$Entry$update,
						author$project$Entry$Description(desc),
						entry) : entry;
				};
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							entries: A2(elm$core$List$map, updateById, model.entries)
						}),
					elm$core$Platform$Cmd$none);
			case 'DeleteEntry':
				var id = msg.a;
			...
			case 'DeleteComplete':
				var date = msg.a;
				var completedOnDate = function (entry) {
					return author$project$Entry$completed(entry) && _Utils_eq(
						author$project$Entry$date(entry),
						date);
				};
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							entries: A2(
								elm$core$List$filter,
								A2(elm$core$Basics$composeL, elm$core$Basics$not, completedOnDate),
								model.entries)
						}),
					elm$core$Platform$Cmd$none);
			case 'CheckEntry':
				...
				var updateEntry = function (t) {
					return _Utils_eq(
						...
						id) ? A2(
						author$project$Entry$update,
						author$project$Entry$Completed(isCompleted),
						t) : t;
				};
				return _Utils_Tuple2(
					_Utils_update(
			...
			default:
				var m = msg.a;
				var _n2 = A2(author$project$Component$EntryList$update, m, model.listState);
				var newState = _n2.a;
				var cmd = _n2.b;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{listState: newState}),
					A2(elm$core$Platform$Cmd$map, author$project$Main$EntryListMsg, cmd));
		}
	});
			...
			elm$core$Platform$Cmd$batch(
				_List_fromArray(
					[
						...
						author$project$Main$serialize(newModel)),
						cmds
					])));
	});
...
var author$project$ImportEntries$filter = F3(
	function (from, to, entries) {
		return A2(
			elm$core$List$filter,
			A2(author$project$ImportEntries$incompleteInRange, from, to),
			entries);
	});
var author$project$Main$ImportPrevious = function (a) {
	return {$: 'ImportPrevious', a: a};
};
var author$project$Main$promptString = F2(
	function (from, count) {
		return 'Import incomplete entries since ' + (A2(justinmimbs$date$Date$format, 'MM/dd/yy', from) + (' (' + (elm$core$String$fromInt(count) + ' entries)?')));
	});
var author$project$Main$viewImportPrompt = F3(
	function (lastOpened, today, entries) {
		var entryCount = elm$core$List$length(
			A3(author$project$ImportEntries$filter, lastOpened, today, entries));
		var contents = (!entryCount) ? _List_Nil : _List_fromArray(
			[
				elm$html$Html$text(
				A2(author$project$Main$promptString, lastOpened, entryCount)),
				A2(
				elm$html$Html$button,
				_List_fromArray(
					[
						elm$html$Html$Events$onClick(
						author$project$Main$ImportPrevious(true))
					]),
				_List_fromArray(
					[
				...
				_List_fromArray(
					[
						elm$html$Html$Events$onClick(
						author$project$Main$ImportPrevious(false))
					]),
				_List_fromArray(
					[
...
var author$project$Main$view = function (model) {
	var importPrompt = function () {
		var _n0 = model.todayDate;
		if (_n0.$ === 'Just') {
			var d = _n0.a;
			return A4(elm$html$Html$Lazy$lazy3, author$project$Main$viewImportPrompt, model.lastOpenedDate, d, model.entries);
		} else {
								...
								return A2(
									...
									function (nextId) {
										return A2(
												...
												return A2(
													...
													function (field) {
														return A2(
															...
															function (entries) {
																return elm$json$Json$Decode$succeed(
																	{entries: entries, field: field, lastOpenedRataDie: lastOpenedRataDie, nextId: nextId, visibility: visibility});
															},
															A2(
																elm$json$Json$Decode$field,
																'entries',
																					...
																					return A2(
																						...
																						function (date) {
																							return A2(
																								...
																								function (completed) {
																									return elm$json$Json$Decode$succeed(
																										{completed: completed, date: date, description: description, id: id});
																								},
											...
											A2(elm$json$Json$Decode$field, 'lastOpenedRataDie', elm$json$Json$Decode$int));
									},
